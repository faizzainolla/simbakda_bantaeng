 ...
 if($pnilai=='1'){
	...
	foreach($hasil->result() as $fa){
		...
		if($ctahun<>''){	
			...
			IF(MAX(a.no_reg)=MIN(a.no_reg),a.no_reg,CONCAT(MIN(a.no_reg),'-',MAX(a.no_reg)))AS no_reg,a.kondisi,a.konstruksi,a.jenis_gedung,
	...
	foreach ($hasilx->result() as $fa){
		...
		<tr>
			<td bgcolor=\"#CCCCCC\" colspan=\"16\" align=\"left\" style=\"font-size:11px; font-family:tahoma;\"><b>$nm_lokasi</b></td>
             ...
             $csql ="SELECT a.kd_unit,b.nm_brg,a.kd_brg,a.tahun,sum(a.total) as nil_baru,
					IF(MAX(a.no_reg)=MIN(a.no_reg),a.no_reg,CONCAT(MIN(a.no_reg),'-',MAX(a.no_reg)))AS no_reg,a.konstruksi,a.panjang,a.lebar,a.luas,a.alamat1,
	...
	if($ctahun==''){
             $csql ="SELECT a.kd_unit,b.nm_brg,a.tahun,a.kd_brg,$tot as nil_baru,
				...
				$csql ="
					...
					IF(MAX(a.no_reg)=MIN(a.no_reg),a.no_reg,CONCAT(MIN(a.no_reg),'-',MAX(a.no_reg)))AS no_reg,a.konstruksi,a.panjang,a.lebar,a.luas,a.alamat1,
					a.tgl_dok,a.kd_tanah,a.no_dok,a.status_tanah,a.asal,sum(a.nilai) as total,'' as nil_kap,sum(a.nilai) as nilai,a.kondisi,a.keterangan FROM trkib_d a 
					...
					'' as nil_kap,a.nilai,a.kondisi,a.keterangan FROM trkib_d_kap a 
	...
	$csql = "SELECT a.kd_unit,b.nm_brg,a.kd_brg,
			IF(MAX(a.no_reg)=MIN(a.no_reg),a.no_reg,
			CONCAT(MIN(a.no_reg),'-',MAX(a.no_reg)))AS no_reg,sum(a.total) as nil_baru,a.judul,a.spesifikasi,a.asal,a.cipta,
	...
	elseif ($cbid == '' && $cini=='fa'){ 
		  ...
		  $csql = " SELECT a.kd_unit,b.nm_brg,a.kd_brg,sum(a.total) as nil_baru,
					IF(MAX(a.no_reg)=MIN(a.no_reg),a.no_reg,CONCAT(MIN(a.no_reg),'-',MAX(a.no_reg)))AS no_reg,a.judul,a.spesifikasi,a.asal,a.cipta,
	...
	function lap_kib_f(){
		...
		a.luas,a.alamat1,a.tgl_reg,IF(MAX(a.no_reg)=MIN(a.no_reg),a.no_reg,
		CONCAT(MIN(a.no_reg),'-',MAX(a.no_reg)))AS reg,a.tgl_awal_kerja,
		a.bangunan,a.kd_tanah,a.tahun,a.asal,sum(a.nilai)as total,a.nilai,a.keterangan FROM trkib_f a 
		INNER JOIN mbarang b ON a.kd_brg=b.kd_brg 
		...
		elseif($cbid=='' && $cini=='fa'){
		$csql = "SELECT b.nm_brg,a.status_tanah,a.konstruksi,a.jenis,sum(a.total) as nil_baru,
		a.luas,a.alamat1,a.tahun,a.tgl_reg,IF(MAX(a.no_reg)=MIN(a.no_reg),a.no_reg,
		CONCAT(MIN(a.no_reg),'-',MAX(a.no_reg)))AS reg,a.tgl_awal_kerja,
         ...
         $cRet = "<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"0\" cellspacing=\"1\" cellpadding=\"1\">
			...
			foreach ($hasilx->result() as $row)
			 ...
			 $nm_skpd = $row->nm_skpd;
				...
				$sqdetail1="SELECT ifnull((sum(a.nilai)),0) as nilai1,ifnull((count(a.nilai)),0) as jumlah1 FROM 
				...
				$sqdetail2="SELECT ifnull((sum(a.nilai)),0) as nilai2,ifnull((count(a.nilai)),0) as jumlah2 FROM 
				...
				$sqdetail3="SELECT ifnull((sum(a.nilai)),0) as nilai3,ifnull((count(a.nilai)),0) as jumlah3 FROM 
				...
				$sqdetail4="SELECT ifnull((sum(a.nilai)),0) as nilai4,ifnull((count(a.nilai)),0) as jumlah4 FROM 
				...
				$sqdetail5="SELECT ifnull((sum(a.nilai)),0) as nilai5,ifnull((count(a.nilai)),0) as jumlah5 FROM 
				...
				$sqdetail6="SELECT ifnull((sum(a.nilai)),0) as nilai6,ifnull((count(a.nilai)),0) as jumlah6 FROM 
				...
				$sqdetail7="SELECT ifnull((sum(a.nilai)),0) as nilai7,ifnull((count(a.nilai)),0) as jumlah7 FROM 
      ...
      $cRet .=" <table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"1\" cellpadding=\"1\">
		...
		foreach ($hasilx->result() as $row)
			 ...
			 $nm_skpd = $row->nm_skpd;
				...
				$sqdetail1="SELECT ifnull((sum(a.total)),0) as nilai1,ifnull((count(a.jumlah)),0) as jumlah1 FROM 
	...
	$cRet .="<tr>
		...
		AND (tgl_riwayat>='$sampai_tgl' OR kd_riwayat IS NULL OR kd_riwayat='' OR kd_riwayat='9')";
		  ...
		  foreach ($hasil->result() as $row){
			...
			$csql = "SELECt ifnull (sum(nilai),0) as nilai FROM trkib_a WHERE left(kd_brg,5)='$ckode2' $skpd $unit AND tgl_reg<='$sampai_tgl' $thn
		AND (no_mutasi IS NULL OR no_mutasi='' OR tgl_mutasi>='$sampai_tgl') 
		AND (no_pindah IS NULL OR no_pindah='' OR tgl_pindah>='$sampai_tgl') 
		AND (no_hapus IS NULL OR no_hapus='' OR tgl_hapus>='$sampai_tgl')  
		AND (tgl_riwayat>='$sampai_tgl' OR kd_riwayat IS NULL OR kd_riwayat='' OR kd_riwayat='9')";
		...
		AND (tgl_riwayat>='$sampai_tgl' OR kd_riwayat IS NULL OR kd_riwayat='' OR kd_riwayat='9')";
		  ...
		  foreach ($hasil->result() as $row){
			...
			$ccsql = "SELECT ifnull (sum(nilai),0) as nilai FROM trkib_b WHERE left(kd_brg,5)='$ckode2' $skpd $unit AND tgl_reg<='$sampai_tgl' $thn
		AND (no_mutasi IS NULL OR no_mutasi='' OR tgl_mutasi>='$sampai_tgl') 
		AND (no_pindah IS NULL OR no_pindah='' OR tgl_pindah>='$sampai_tgl') 
		AND (no_hapus IS NULL OR no_hapus='' OR tgl_hapus>='$sampai_tgl')  
		AND (tgl_riwayat>='$sampai_tgl' OR kd_riwayat IS NULL OR kd_riwayat='' OR kd_riwayat='9')";
		...
		$nil_eca";
			...
			$csql = "SELECt ifnull (sum(nilai),0) as nilai FROM trkib_c WHERE left(kd_brg,5)='$ckode2' $skpd $unit AND tgl_reg<='$sampai_tgl' $thn
		AND (no_mutasi IS NULL OR no_mutasi='' OR tgl_mutasi>='$sampai_tgl') 
		AND (no_pindah IS NULL OR no_pindah='' OR tgl_pindah>='$sampai_tgl') 
		AND (no_hapus IS NULL OR no_hapus='' OR tgl_hapus>='$sampai_tgl')  
		AND (tgl_riwayat>='$sampai_tgl' OR kd_riwayat IS NULL OR kd_riwayat='' OR kd_riwayat='9')
		...
		AND (tgl_riwayat>='$sampai_tgl' OR kd_riwayat IS NULL OR kd_riwayat='' OR kd_riwayat='9')";
			...
			$csql = "SELECt ifnull (sum(nilai),0) as nilai FROM trkib_d WHERE left(kd_brg,5)='$ckode2' $skpd $unit AND tgl_reg<='$sampai_tgl' $thn 
		AND (no_mutasi IS NULL OR no_mutasi='' OR tgl_mutasi>='$sampai_tgl') 
		AND (no_pindah IS NULL OR no_pindah='' OR tgl_pindah>='$sampai_tgl') 
		AND (no_hapus IS NULL OR no_hapus='' OR tgl_hapus>='$sampai_tgl')  
		AND (tgl_riwayat>='$sampai_tgl' OR kd_riwayat IS NULL OR kd_riwayat='' OR kd_riwayat='9')";
		...
		AND (tgl_riwayat>='$sampai_tgl' OR kd_riwayat IS NULL OR kd_riwayat='' OR kd_riwayat='9')";
			...
			$csql = "SELECt ifnull (sum(nilai),0) as nilai FROM trkib_e WHERE left(kd_brg,5)='$ckode2' $skpd $unit AND tgl_reg<='$sampai_tgl' $thn
		AND (no_mutasi IS NULL OR no_mutasi='' OR tgl_mutasi>='$sampai_tgl') 
		AND (no_pindah IS NULL OR no_pindah='' OR tgl_pindah>='$sampai_tgl') 
		AND (no_hapus IS NULL OR no_hapus='' OR tgl_hapus>='$sampai_tgl')  
		AND (tgl_riwayat>='$sampai_tgl' OR kd_riwayat IS NULL OR kd_riwayat='' OR kd_riwayat='9')";
		...
		AND (tgl_riwayat>='$sampai_tgl' OR kd_riwayat IS NULL OR kd_riwayat='' OR kd_riwayat='9')";
			...
			$csql = "SELECt ifnull (sum(nilai),0) as nilai FROM trkib_f WHERE left(kd_brg,5)='$ckode2' $skpd $unit AND tgl_reg<='$sampai_tgl' $thn 
		AND (no_mutasi IS NULL OR no_mutasi='' OR tgl_mutasi>='$sampai_tgl') 
		AND (no_pindah IS NULL OR no_pindah='' OR tgl_pindah>='$sampai_tgl') 
		AND (no_hapus IS NULL OR no_hapus='' OR tgl_hapus>='$sampai_tgl')  
		AND (tgl_riwayat>='$sampai_tgl' OR kd_riwayat IS NULL OR kd_riwayat='' OR kd_riwayat='9')";
...
$cnama	= $row->nama;
	...
	$cRet .="<tr>
		...
		AND (tgl_riwayat>='$sampai_tgl' OR kd_riwayat IS NULL OR kd_riwayat='' OR kd_riwayat='9')";
			...
			$csql = "SELECt ifnull (sum(total),0) as nilai FROM trkib_e WHERE left(kd_brg,5)='$ckode2' $skpd $unit AND tgl_reg<='$sampai_tgl' 
		AND (no_mutasi IS NULL OR no_mutasi='' OR tgl_mutasi>='$sampai_tgl') 
		AND (no_pindah IS NULL OR no_pindah='' OR tgl_pindah>='$sampai_tgl') 
		AND (no_hapus IS NULL OR no_hapus='' OR tgl_hapus>='$sampai_tgl')  
		AND (tgl_riwayat>='$sampai_tgl' OR kd_riwayat IS NULL OR kd_riwayat='' OR kd_riwayat='9')";
		...
		AND (tgl_riwayat>='$sampai_tgl' OR kd_riwayat IS NULL OR kd_riwayat='' OR kd_riwayat='9')";
			...
			$csql = "SELECt ifnull (sum(total),0) as nilai FROM trkib_f WHERE left(kd_brg,5)='$ckode2' $skpd $unit AND tgl_reg<='$sampai_tgl' 
		AND (no_mutasi IS NULL OR no_mutasi='' OR tgl_mutasi>='$sampai_tgl') 
		AND (no_pindah IS NULL OR no_pindah='' OR tgl_pindah>='$sampai_tgl') 
		AND (no_hapus IS NULL OR no_hapus='' OR tgl_hapus>='$sampai_tgl')  
		AND (tgl_riwayat>='$sampai_tgl' OR kd_riwayat IS NULL OR kd_riwayat='' OR kd_riwayat='9')";
	...
	$cRet .="<tr>
		...
		if ($ckodex=='01'){
		  ...
		  foreach ($hasil->result() as $row){
			...
			$csql = "SELECt ifnull (sum(nilai),0) as nilai FROM trkib_a WHERE left(kd_brg,5)='$ckode2' and tgl_reg<='$tgl_awal' $skpd $unit";
			$hasil = $this->db->query($csql);
			foreach ($hasil->result() as $row){
            $charga2 = $row->nilai;
			}					
		...
		if ($ckodex=='02'){
		  ...
		  foreach ($hasil->result() as $row){
			...
			$ccsql = "SELECT ifnull (sum(nilai),0) as nilai FROM trkib_b WHERE left(kd_brg,5)='$ckode2' and tgl_reg<='$tgl_awal' $skpd $unit";
			$hasil = $this->db->query($ccsql);
			foreach ($hasil->result() as $row){
            $charga2 = $row->nilai;
			}
		...
		if ($ckodex=='03'){
			...
			$csql = "SELECt ifnull (sum(nilai),0) as nilai FROM trkib_c WHERE left(kd_brg,5)='$ckode2' and tgl_reg<='$tgl_awal' $skpd $unit";
			$hasil = $this->db->query($csql);
			...
			$csql = "SELECt ifnull (sum(nilai),0) as nilai FROM trkib_d WHERE left(kd_brg,5)='$ckode2' and tgl_reg<='$tgl_awal' $skpd $unit";
			$hasil = $this->db->query($csql);
			...
			$csql = "SELECt ifnull (sum(nilai),0) as nilai FROM trkib_e WHERE left(kd_brg,5)='$ckode2' and tgl_reg<='$tgl_awal' $skpd $unit";
			$hasil = $this->db->query($csql);
			...
			$csql = "SELECt ifnull (sum(nilai),0) as nilai FROM trkib_f WHERE left(kd_brg,5)='$ckode2' and tgl_reg<='$tgl_awal' $skpd $unit";
			$hasil = $this->db->query($csql);
		...
		if ($ckodex=='01'){
		  ...
		  foreach ($hasil->result() as $row){
			...
			$csql = "SELECt ifnull (sum(no_hapus),0) as nilai FROM trkib_a WHERE left(kd_brg,5)='$ckode2' $skpd $unit";
			$hasil = $this->db->query($csql);
			foreach ($hasil->result() as $row){
            $charga3 = $row->nilai;
			}					
		...
		if ($ckodex=='02'){
		  ...
		  foreach ($hasil->result() as $row){
			...
			$ccsql = "SELECT ifnull (sum(no_hapus),0) as nilai FROM trkib_b WHERE left(kd_brg,5)='$ckode2' $skpd $unit";
			$hasil = $this->db->query($ccsql);
			foreach ($hasil->result() as $row){
            $charga3 = $row->nilai;
			}
		...
		if ($ckodex=='03'){
			...
			$csql = "SELECt ifnull (sum(no_hapus),0) as nilai FROM trkib_c WHERE left(kd_brg,5)='$ckode2' $skpd $unit";
			$hasil = $this->db->query($csql);
			...
			$csql = "SELECt ifnull (sum(no_hapus),0) as nilai FROM trkib_d WHERE left(kd_brg,5)='$ckode2' $skpd $unit";
			$hasil = $this->db->query($csql);
			...
			$csql = "SELECt ifnull (sum(no_hapus),0) as nilai FROM trkib_e WHERE left(kd_brg,5)='$ckode2' $skpd $unit";
			$hasil = $this->db->query($csql);
			...
			$csql = "SELECt ifnull (sum(no_hapus),0) as nilai FROM trkib_f WHERE left(kd_brg,5)='$ckode2' $skpd $unit";
			$hasil = $this->db->query($csql);
		...
		if ($ckodex=='01'){
		  ...
		  foreach ($hasil->result() as $row){
			...
			$csql = "SELECt ifnull (sum(nilai),0) as nilai FROM trkib_a WHERE left(kd_brg,5)='$ckode2' and tgl_reg between '$tgl_awal' and '$tgl_akhir' $skpd $unit";
			$hasil = $this->db->query($csql);
			foreach ($hasil->result() as $row){
            $charga4 = $row->nilai;
			}					
		...
		if ($ckodex=='02'){
		  ...
		  foreach ($hasil->result() as $row){
			...
			$ccsql = "SELECT ifnull (sum(nilai),0) as nilai FROM trkib_b WHERE left(kd_brg,5)='$ckode2' and tgl_reg between '$tgl_awal' and '$tgl_akhir' $skpd $unit";
			$hasil = $this->db->query($ccsql);
			foreach ($hasil->result() as $row){
            $charga4 = $row->nilai;
			}
		...
		$faiz="select count(nilai) as jml_kap,sum(nilai) as nil_kap from trkib_c_kap where tgl_reg <='$tgl_akhir' $skpd $unit";
			...
			$csql = "SELECt ifnull (sum(nilai),0) as nilai FROM trkib_c WHERE left(kd_brg,5)='$ckode2' and tgl_reg between '$tgl_awal' and '$tgl_akhir' $skpd $unit";
			$hasil = $this->db->query($csql);
			...
			$csql = "SELECt ifnull (sum(nilai),0) as nilai FROM trkib_d WHERE left(kd_brg,5)='$ckode2' and tgl_reg between '$tgl_awal' and '$tgl_akhir' $skpd $unit";
			$hasil = $this->db->query($csql);
			...
			$csql = "SELECt ifnull (sum(nilai),0) as nilai FROM trkib_e WHERE left(kd_brg,5)='$ckode2' and tgl_reg between '$tgl_awal' and '$tgl_akhir' $skpd $unit";
			$hasil = $this->db->query($csql);
			...
			$csql = "SELECt ifnull (sum(nilai),0) as nilai FROM trkib_f WHERE left(kd_brg,5)='$ckode2' and tgl_reg between '$tgl_awal' and '$tgl_akhir' $skpd $unit";
			$hasil = $this->db->query($csql);
	...
	$cRet .="<tr>
		...
		if ($ckodex=='01'){
		  ...
		  foreach ($hasil->result() as $row){
			...
			$csql = "SELECT ifnull (sum(nilai),0) as nilai FROM trkib_a WHERE left(kd_brg,5)='$ckode2' 
			and tgl_reg<='$tgl_awal' $skpd $unit
			AND (no_mutasi IS NULL OR no_mutasi='' OR tgl_mutasi>='$tgl_awal') 
			AND (no_hapus IS NULL OR no_hapus='' OR tgl_hapus>='$tgl_awal')  ";
			$hasil = $this->db->query($csql);
		...
		if ($ckodex=='02'){
		  ...
		  foreach ($hasil->result() as $row){
			...
			$ccsql = "SELECT ifnull (sum(nilai),0) as nilai FROM trkib_b WHERE left(kd_brg,5)='$ckode2' 
			and tgl_reg<='$tgl_awal' $skpd $unit
			AND (no_mutasi IS NULL OR no_mutasi='' OR tgl_mutasi>='$tgl_awal') 
			AND (no_hapus IS NULL OR no_hapus='' OR tgl_hapus>='$tgl_awal')  ";
			$hasil = $this->db->query($ccsql);
		...
		if ($ckodex=='03'){
			...
			$csql = "SELECt ifnull (sum(nilai),0) as nilai FROM trkib_c WHERE left(kd_brg,5)='$ckode2' 
			and tgl_reg<='$tgl_awal' $skpd $unit	
			AND (no_mutasi IS NULL OR no_mutasi='' OR tgl_mutasi>='$tgl_awal') 
			AND (no_hapus IS NULL OR no_hapus='' OR tgl_hapus>='$tgl_awal')  ";
			$hasil = $this->db->query($csql);
			...
			$csql = "SELECt ifnull (sum(nilai),0) as nilai FROM trkib_d WHERE left(kd_brg,5)='$ckode2' 
			and tgl_reg<='$tgl_awal' $skpd $unit
			AND (no_mutasi IS NULL OR no_mutasi='' OR tgl_mutasi>='$tgl_awal') 
			AND (no_hapus IS NULL OR no_hapus='' OR tgl_hapus>='$tgl_awal')  ";
			$hasil = $this->db->query($csql);
			...
			$csql = "SELECt ifnull (sum(nilai),0) as nilai FROM trkib_e WHERE left(kd_brg,5)='$ckode2' 
			and tgl_reg<='$tgl_awal' $skpd $unit
			AND (no_mutasi IS NULL OR no_mutasi='' OR tgl_mutasi>='$tgl_awal') 
			AND (no_hapus IS NULL OR no_hapus='' OR tgl_hapus>='$tgl_awal')  ";
			$hasil = $this->db->query($csql);
			...
			$csql = "SELECt ifnull (sum(nilai),0) as nilai FROM trkib_f WHERE left(kd_brg,5)='$ckode2' 
			and tgl_reg<='$tgl_awal' $skpd $unit
			AND (no_mutasi IS NULL OR no_mutasi='' OR tgl_mutasi>='$tgl_awal') 
			AND (no_hapus IS NULL OR no_hapus='' OR tgl_hapus>='$tgl_awal')  ";
			$hasil = $this->db->query($csql);
	...
	$cRet .="<tr>
		...
		if ($ckodex=='01'){
		  ...
		  foreach ($hasil->result() as $row){
			...
			$csql = "SELECT ifnull (sum(total),0) as nilai FROM trkib_a WHERE left(kd_brg,5)='$ckode2' 
			and tgl_reg<='$tgl_awal' $skpd $unit
			AND (no_mutasi IS NULL OR no_mutasi='' OR tgl_mutasi>='$tgl_awal') 
			AND (no_hapus IS NULL OR no_hapus='' OR tgl_hapus>='$tgl_awal')  ";
			$hasil = $this->db->query($csql);
		...
		if ($ckodex=='02'){
		  ...
		  foreach ($hasil->result() as $row){
			...
			$ccsql = "SELECT ifnull (sum(total),0) as nilai FROM trkib_b WHERE left(kd_brg,5)='$ckode2' 
			and tgl_reg<='$tgl_awal' $skpd $unit
			AND (no_mutasi IS NULL OR no_mutasi='' OR tgl_mutasi>='$tgl_awal') 
			AND (no_hapus IS NULL OR no_hapus='' OR tgl_hapus>='$tgl_awal')  ";
			$hasil = $this->db->query($ccsql);
		...
		if ($ckodex=='03'){
			...
			$csql = "SELECt ifnull (sum(total),0) as nilai FROM trkib_c WHERE left(kd_brg,5)='$ckode2' 
			and tgl_reg<='$tgl_awal' $skpd $unit	
			AND (no_mutasi IS NULL OR no_mutasi='' OR tgl_mutasi>='$tgl_awal') 
			AND (no_hapus IS NULL OR no_hapus='' OR tgl_hapus>='$tgl_awal')  ";
			$hasil = $this->db->query($csql);
			...
			$csql = "SELECt ifnull (sum(total),0) as nilai FROM trkib_d WHERE left(kd_brg,5)='$ckode2' 
			and tgl_reg<='$tgl_awal' $skpd $unit
			AND (no_mutasi IS NULL OR no_mutasi='' OR tgl_mutasi>='$tgl_awal') 
			AND (no_hapus IS NULL OR no_hapus='' OR tgl_hapus>='$tgl_awal')  ";
			$hasil = $this->db->query($csql);
			...
			$csql = "SELECt ifnull (sum(total),0) as nilai FROM trkib_e WHERE left(kd_brg,5)='$ckode2' 
			and tgl_reg<='$tgl_awal' $skpd $unit
			AND (no_mutasi IS NULL OR no_mutasi='' OR tgl_mutasi>='$tgl_awal') 
			AND (no_hapus IS NULL OR no_hapus='' OR tgl_hapus>='$tgl_awal')  ";
			$hasil = $this->db->query($csql);
			...
			$csql = "SELECt ifnull (sum(total),0) as nilai FROM trkib_f WHERE left(kd_brg,5)='$ckode2' 
			and tgl_reg<='$tgl_awal' $skpd $unit
			AND (no_mutasi IS NULL OR no_mutasi='' OR tgl_mutasi>='$tgl_awal') 
			AND (no_hapus IS NULL OR no_hapus='' OR tgl_hapus>='$tgl_awal')  ";
			$hasil = $this->db->query($csql);
		...
		if ($ckodex=='01'){
		  ...
		  foreach ($hasil->result() as $row){
			...
			$csql = "SELECt ifnull (sum(total),0) as nilai FROM trkib_a WHERE left(kd_brg,5)='$ckode2' $skpd $unit
					and (tgl_mutasi between '$tgl_awal' and '$tgl_akhir' or 
					tgl_pindah between '$tgl_awal' and '$tgl_akhir' or 
					tgl_riwayat between '$tgl_awal' and '$tgl_akhir'
				or	tgl_hapus between '$tgl_awal' and '$tgl_akhir')
		...
		if ($ckodex=='02'){
		  ...
		  foreach ($hasil->result() as $row){
			...
			$ccsql = "SELECT ifnull (sum(total),0) as nilai FROM trkib_b WHERE left(kd_brg,5)='$ckode2' $skpd $unit
					and (tgl_mutasi between '$tgl_awal' and '$tgl_akhir' or 
					tgl_pindah between '$tgl_awal' and '$tgl_akhir' or 
					tgl_riwayat between '$tgl_awal' and '$tgl_akhir'
				or	tgl_hapus between '$tgl_awal' and '$tgl_akhir')
		...
		if ($ckodex=='03'){
			...
			$csql = "SELECt ifnull (sum(total),0) as nilai FROM trkib_c WHERE left(kd_brg,5)='$ckode2' $skpd $unit
					and (tgl_mutasi between '$tgl_awal' and '$tgl_akhir' or 
					tgl_pindah between '$tgl_awal' and '$tgl_akhir' or 
					tgl_riwayat between '$tgl_awal' and '$tgl_akhir'
				or	tgl_hapus between '$tgl_awal' and '$tgl_akhir')
			...
			$csql = "SELECT ifnull (sum(total),0) as nilai FROM trkib_d WHERE left(kd_brg,5)='$ckode2' $skpd $unit
					and (tgl_mutasi between '$tgl_awal' and '$tgl_akhir' or 
					tgl_pindah between '$tgl_awal' and '$tgl_akhir' or 
					tgl_riwayat between '$tgl_awal' and '$tgl_akhir'
				or	tgl_hapus between '$tgl_awal' and '$tgl_akhir')
			...
			$csql = "SELECt ifnull (sum(total),0) as nilai FROM trkib_e WHERE left(kd_brg,5)='$ckode2' $skpd $unit
					and (tgl_mutasi between '$tgl_awal' and '$tgl_akhir' or 
					tgl_pindah between '$tgl_awal' and '$tgl_akhir' or 
					tgl_riwayat between '$tgl_awal' and '$tgl_akhir'
				or	tgl_hapus between '$tgl_awal' and '$tgl_akhir')
...
if($jenis=='1'){
	...
	'' as nil_kap,a.asal,a.tahun,a.luas AS silinder,'-' kd_satuan,'-' AS kondisi,COUNT(a.nilai) AS jumlah,IFNULL(SUM(a.nilai),0) AS nilai,sum(nilai) as nilai1,count(nilai) as jumlah1,LEFT(RTRIM(a.keterangan),25) AS keterangan 
	...
	'' as nil_kap,a.asal,a.tahun,a.silinder,a.kd_satuan,a.kondisi,COUNT(a.nilai) AS jumlah,IFNULL(SUM(a.nilai),0) AS nilai,sum(nilai) as nilai2,count(nilai) as jumlah2,LEFT(RTRIM(a.keterangan),25) AS keterangan
	...
	(SELECT if($pnilai='1',SUM(nilai),SUM(total)) FROM trkib_c_kap WHERE kd_skpd=a.kd_skpd and a.kd_unit=kd_unit 
			and a.id_barang=id_barang and tgl_reg<='$sampai_tgl') as nil_kap,
	a.asal,a.tahun,a.lebar AS silinder,'' AS kd_satuan,a.kondisi,COUNT(a.nilai) AS jumlah,IFNULL(SUM(a.nilai),0) AS nilai,sum(nilai) as nilai4,count(nilai) as jumlah4,LEFT(RTRIM(a.keterangan),25) AS keterangan
	...
	'' as nil_kap,a.peroleh AS asal,a.tahun,a.tipe AS silinder,a.kd_satuan,a.kondisi,COUNT(a.nilai) AS jumlah,IFNULL(SUM(a.nilai),0) AS nilai,sum(nilai) as nilai5,count(nilai) as jumlah5,LEFT(RTRIM(a.keterangan),25) AS keterangan 
	...
	'' as nil_kap,a.asal,a.tahun,'' AS silinder,'' AS kd_satuan,a.kondisi,COUNT(a.nilai) AS jumlah,IFNULL(SUM(a.nilai),0) AS nilai,sum(nilai) as nilai6,count(nilai) as jumlah6,LEFT(RTRIM(a.keterangan),25) AS keterangan
...
//NILAIBARU
		...
		if($jenis=='1'){
	$sql1="SELECT a.kd_brg,IF(MAX(a.no_reg)=MIN(a.no_reg),a.no_reg,CONCAT(MIN(a.no_reg),'-',MAX(a.no_reg)))AS no_reg,LEFT(RTRIM(b.nm_brg),36) AS nm_brg,'-' AS merek,a.no_sertifikat AS gabung,'-' AS kd_bahan,
	'' as nil_kap,a.asal,a.tahun,a.luas AS silinder,'-' kd_satuan,'-' AS kondisi,COUNT(a.total) AS jumlah,IFNULL(SUM(a.total),0) AS nilai,sum(total) as nilai1,count(total) as jumlah1,LEFT(RTRIM(a.keterangan),25) AS keterangan 
	FROM trkib_a a left join mbarang b on a.kd_brg=b.kd_brg WHERE a.kd_skpd='$cskpd' AND a.tgl_reg<='$sampai_tgl' $th 
			AND (a.no_mutasi IS NULL OR a.no_mutasi='' OR a.tgl_mutasi>='$sampai_tgl') 
			AND (a.no_pindah IS NULL OR a.no_pindah='' OR a.tgl_pindah>='$sampai_tgl') 
			AND (a.no_hapus IS NULL OR a.no_hapus='' OR a.tgl_hapus>='$sampai_tgl')  
	...
	$sql1x="SELECT a.kd_brg,IF(MAX(a.no_reg)=MIN(a.no_reg),a.no_reg,CONCAT(MIN(a.no_reg),'-',MAX(a.no_reg)))AS no_reg,LEFT(RTRIM(b.nm_brg),36) AS nm_brg,LEFT(RTRIM(a.merek),15) as merek,LEFT(RTRIM(CONCAT(a.pabrik,'/',no_rangka,'/',no_mesin)),11) AS gabung,a.kd_bahan,
	'' as nil_kap,a.asal,a.tahun,a.silinder,a.kd_satuan,a.kondisi,COUNT(a.total) AS jumlah,IFNULL(SUM(a.total),0) AS nilai,sum(total) as nilai2,count(total) as jumlah2,LEFT(RTRIM(a.keterangan),25) AS keterangan
	FROM trkib_b a left join mbarang b on a.kd_brg=b.kd_brg  WHERE a.kd_skpd='$cskpd' AND a.tgl_reg<='$sampai_tgl' $th 
			AND (a.no_mutasi IS NULL OR a.no_mutasi='' OR a.tgl_mutasi>='$sampai_tgl') 
			AND (a.no_pindah IS NULL OR a.no_pindah='' OR a.tgl_pindah>='$sampai_tgl') 
			AND (a.no_hapus IS NULL OR a.no_hapus='' OR a.tgl_hapus>='$sampai_tgl')  
	...
	(SELECT if($pnilai='1',SUM(nilai),SUM(total)) FROM trkib_c_kap WHERE kd_skpd=a.kd_skpd and a.kd_unit=kd_unit 
			and a.id_barang=id_barang and tgl_reg<='$sampai_tgl') as nil_kap,
	a.asal,a.tahun,a.konstruksi AS silinder,'' AS kd_satuan,a.kondisi,COUNT(a.total) AS jumlah,IFNULL(SUM(a.total),0) AS nilai,sum(total) as nilai3,count(total) as jumlah3,LEFT(RTRIM(a.keterangan),25) AS keterangan
	FROM trkib_c a left join mbarang b on a.kd_brg=b.kd_brg  WHERE a.kd_skpd='$cskpd' AND a.tgl_reg<='$sampai_tgl' $th 
			AND (a.no_mutasi IS NULL OR a.no_mutasi='' OR a.tgl_mutasi>='$sampai_tgl') 
			AND (a.no_pindah IS NULL OR a.no_pindah='' OR a.tgl_pindah>='$sampai_tgl') 
			AND (a.no_hapus IS NULL OR a.no_hapus='' OR a.tgl_hapus>='$sampai_tgl')  
	...
	(SELECT if($pnilai='1',SUM(nilai),SUM(total)) FROM trkib_c_kap WHERE kd_skpd=a.kd_skpd and a.kd_unit=kd_unit 
			and a.id_barang=id_barang and tgl_reg<='$sampai_tgl') as nil_kap,
	a.asal,a.tahun,a.lebar AS silinder,'' AS kd_satuan,a.kondisi,COUNT(a.total) AS jumlah,IFNULL(SUM(a.total),0) AS nilai,sum(total) as nilai4,count(total) as jumlah4,LEFT(RTRIM(a.keterangan),25) AS keterangan
	FROM trkib_d a left join mbarang b on a.kd_brg=b.kd_brg  WHERE a.kd_skpd='$cskpd' AND a.tgl_reg<='$sampai_tgl' $th 
			AND (a.no_mutasi IS NULL OR a.no_mutasi='' OR a.tgl_mutasi>='$sampai_tgl') 
			AND (a.no_pindah IS NULL OR a.no_pindah='' OR a.tgl_pindah>='$sampai_tgl') 
			AND (a.no_hapus IS NULL OR a.no_hapus='' OR a.tgl_hapus>='$sampai_tgl')  
	...
	$sql1xxxx="SELECT a.kd_brg,IF(MAX(a.no_reg)=MIN(a.no_reg),a.no_reg,CONCAT(MIN(a.no_reg),'-',MAX(a.no_reg)))AS no_reg,LEFT(RTRIM(b.nm_brg),36) AS nm_brg,LEFT(RTRIM(a.judul),15) as merek,a.spesifikasi AS gabung,a.kd_bahan,
	'' as nil_kap,a.peroleh AS asal,a.tahun,a.tipe AS silinder,a.kd_satuan,a.kondisi,COUNT(a.total) AS jumlah,IFNULL(SUM(a.total),0) AS nilai,sum(total) as nilai5,count(total) as jumlah5,LEFT(RTRIM(a.keterangan),25) AS keterangan 
	FROM trkib_e a left join mbarang b on a.kd_brg=b.kd_brg  WHERE a.kd_skpd='$cskpd' AND a.tgl_reg<='$sampai_tgl' $th 
			AND (a.no_mutasi IS NULL OR a.no_mutasi='' OR a.tgl_mutasi>='$sampai_tgl') 
			AND (a.no_pindah IS NULL OR a.no_pindah='' OR a.tgl_pindah>='$sampai_tgl') 
			AND (a.no_hapus IS NULL OR a.no_hapus='' OR a.tgl_hapus>='$sampai_tgl')  
	...
	$sql1xxxxx="SELECT a.kd_brg,IF(MAX(a.no_reg)=MIN(a.no_reg),a.no_reg,CONCAT(MIN(a.no_reg),'-',MAX(a.no_reg)))AS no_reg,LEFT(RTRIM(b.nm_brg),36) AS nm_brg,'' AS merek,a.luas AS gabung,'' AS kd_bahan,
	'' as nil_kap,a.asal,a.tahun,'' AS silinder,'' AS kd_satuan,a.kondisi,COUNT(a.total) AS jumlah,IFNULL(SUM(a.total),0) AS nilai,sum(total) as nilai6,count(total) as jumlah6,LEFT(RTRIM(a.keterangan),25) AS keterangan
	FROM trkib_f a left join mbarang b on a.kd_brg=b.kd_brg  WHERE a.kd_skpd='$cskpd' AND a.tgl_reg<='$sampai_tgl' $th 
			AND (a.no_mutasi IS NULL OR a.no_mutasi='' OR a.tgl_mutasi>='$sampai_tgl') 
			AND (a.no_pindah IS NULL OR a.no_pindah='' OR a.tgl_pindah>='$sampai_tgl') 
			AND (a.no_hapus IS NULL OR a.no_hapus='' OR a.tgl_hapus>='$sampai_tgl')  
