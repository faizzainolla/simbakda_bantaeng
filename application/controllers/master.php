 ...
 function load_golongan() {
    ...
    function load_unit_bidang() {
       if($this->auth->is_logged_in() == false){
        ...
        $where ='';
        if ($kriteria <> ''){                               
            $where="where nm_uskpd like'%$kriteria%' or kd_uskpd like'%kriteria%'";            
        }
    ...
    function load_bidang() {
      ...
      function load_usaha() {
       if($this->auth->is_logged_in() == false){
        ...
        $rs = $this->db->query("select count(*) as tot FROM mcompany a $where1 $where2 order by kd_comp");
        $trh = $rs->row();
        //$result["total"] = $trh->tot;
        ...
        $sql = "SELECT a.*, CASE 
                    ...
                    END AS nmbentuk FROM mcompany a $where1 $where2 order by kd_comp limit $offset,$rows";
        $query1 = $this->db->query($sql);  
        //$result = array();
...
//------------------------//	
	...
	function ambil_ubidskpd2() {
        ...
        $sql = "SELECT kd_skpd,kd_lokasi, nm_lokasi FROM mlokasi $where1 $where2 group by kd_skpd order by nm_lokasi";
        $query1 = $this->db->query($sql);  
        $result = array();
        $ii = 0;
        foreach($query1->result_array() as $resulte)
...
/* 	
    ...
    function tahun() {
        ...
        $sql = "SELECT tahun FROM tahun order by tahun";
        $query1 = $this->db->query($sql);  
        $result = array();
        $ii = 0;
        foreach($query1->result_array() as $resulte)
