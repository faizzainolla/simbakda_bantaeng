...
class Transaksi extends CI_Controller {
    ...
    function trh_isianbrg(){
        ...
        $sql = " select a.*,b.nm_comp,c.nm_milik 
				 from trh_isianbrg a left join mcompany b on a.kd_comp=b.kd_comp 
                 left join mmilik c on a.kd_milik = c.kd_milik $where1 $where 
				 order by tgl_dokumen,no_dokumen,a.kd_comp limit $offset,$rows";
        $query1 = $this->db->query($sql);          
        $ii = 0;
        foreach($query1->result_array() as $resulte)
        {            
  ...
  function ambil_kib_a_k() {
    ...
    function ambil_kib_b() {
        ...
        $sql = "SELECT a.*,b.nm_brg FROM trkib_b a left join
				mbarang b on b.kd_brg = a.kd_brg $where1 $where2 order by a.tahun,a.kd_brg limit $offset,$rows";
     ...
     function ambil_kib_c() {
        ...
        $sql = "SELECT a.*,b.nm_brg FROM trkib_c a left JOIN mbarang b ON b.kd_brg = a.kd_brg $where1 $where2 order by a.tahun,a.kd_brg limit $offset,$rows";
	...
	function riwayat_kib_c() {
     ...
     function ambil_kib_d() {
        ...
        $sql = "SELECT a.*,b.nm_brg FROM trkib_d a left JOIN mbarang b ON 
				a.kd_brg = b.kd_brg $where1 $where2 order by a.tahun,a.kd_brg limit $offset,$rows";
   ...
   function ambil_kib_e() {
        ...
        $sql = "SELECT a.*,b.nm_brg from trkib_e a inner join mbarang b on b.kd_brg = a.kd_brg
...
function simpan_peliharabrg(){
  ...
  function save_trmbrg(){
    ...
    function trh_klrbrg(){
        ...
        if($oto == '01'){ 
            ...
            $where1 = "where kd_uskpd ='$skpd' and tahun='$thn'";
        }
        $result = array();
        $row = array();
      	$page = isset($_POST['page']) ? intval($_POST['page']) : 1;
  ...
  function ambil_trmbrg(){
    ...
    { 
        ...
        if($lckib == '01'){ 
			$sql="SELECT * FROM v_mts_a a WHERE a.kd_unit ='$kdskpd' $where and a.no_mutasi is null order by a.kd_brg";
/*         $sql = "SELECT a.id_barang,a.no_reg AS reg,a.kd_brg,c.nm_brg,a.no_dokumen,a.tgl_reg,a.tahun,a.nilai,a.kondisi 
		FROM trkib_a a LEFT JOIN mbarang c ON a.kd_brg = c.kd_brg WHERE a.kd_unit ='$kdskpd' and a.no_mutasi is null order by a.kd_brg";
 */        }
        
        if($lckib == '02'){       
			$sql="SELECT * FROM v_mts_b a WHERE a.kd_unit ='$kdskpd' $where and a.no_mutasi is null order by a.kd_brg";
/*         $sql =  "SELECT a.id_barang,a.no_reg AS reg,a.kd_brg,c.nm_brg,a.no_dokumen,a.tgl_reg,a.tahun,a.nilai,a.kondisi FROM trkib_b a 
		LEFT JOIN mbarang c ON a.kd_brg = c.kd_brg WHERE a.kd_unit ='$kdskpd' and a.no_mutasi is null order by a.kd_brg ";
 */        }
        
        if($lckib == '03'){ 
			$sql="SELECT * FROM v_mts_c a WHERE a.kd_unit ='$kdskpd' $where and a.no_mutasi is null order by a.kd_brg";
/*         $sql =  "SELECT a.id_barang,a.no_reg AS reg,a.kd_brg,c.nm_brg,a.no_dokumen,a.tgl_reg,a.tahun,a.nilai,a.kondisi FROM trkib_c a
		LEFT JOIN mbarang c ON a.kd_brg = c.kd_brg  WHERE a.kd_unit ='$kdskpd' and a.no_mutasi is null order by a.kd_brg";
 */        }
                
        if($lckib == '04'){   
			$sql="SELECT * FROM v_mts_d a WHERE a.kd_unit ='$kdskpd' $where order by a.kd_brg and a.no_mutasi is null";
/*         $sql =  "SELECT a.id_barang,a.no_reg AS reg,a.kd_brg,c.nm_brg,a.no_dokumen,a.tgl_reg,a.tahun,a.nilai,a.kondisi FROM trkib_d a 
		LEFT JOIN mbarang c ON a.kd_brg = c.kd_brg  WHERE a.kd_unit ='$kdskpd' and a.no_mutasi is null order by a.kd_brg";
 */        }
        
        if($lckib == '05'){  
			$sql="SELECT * FROM v_mts_e a WHERE a.kd_unit ='$kdskpd' $where and a.no_mutasi is null order by a.kd_brg";
/*         $sql = "SELECT a.id_barang,a.no_reg AS reg,a.kd_brg,c.nm_brg,a.no_dokumen,a.tgl_reg,a.tahun,a.nilai,a.kondisi FROM trkib_e a 
		LEFT JOIN mbarang c ON a.kd_brg = c.kd_brg  WHERE a.kd_unit ='$kdskpd' and a.no_mutasi is null order by a.kd_brg";
 */        }
        
        if($lckib == '06'){        
			$sql="SELECT * FROM v_mts_f a WHERE a.kd_unit ='$kdskpd' $where and a.no_mutasi is null order by a.kd_brg";
/*         $sql = "SELECT a.id_barang,a.no_reg AS reg,a.kd_brg,c.nm_brg,a.no_dokumen,a.tgl_reg,a.tahun,a.nilai,a.kondisi FROM trkib_f a 
		LEFT JOIN mbarang c ON a.kd_brg = c.kd_brg  WHERE a.kd_unit ='$kdskpd' and a.no_mutasi is null order by a.kd_brg";
 */        }
