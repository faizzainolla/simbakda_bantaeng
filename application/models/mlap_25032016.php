        ...
        $cRet .= "<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"0\" cellspacing=\"1\" cellpadding=\"1\">
            ...
            <tr>
             ...
             $csql = "SELECT a.nm_brg,a.merek,a.jumlah,a.jumlah AS jml,a.harga AS nil,(SELECT IFNULL((a.harga),0)) AS harga,a.kd_brg,b.kd_rek5,a.ket
                      ...
                      trh_planbrg c ON a.no_dokumen = c.no_dokumen  AND a.kd_uskpd = c.kd_uskpd AND a.kd_unit = c.kd_unit  WHERE c.kd_uskpd = '$cskpd' AND c.tahun='$tahun'";
	...
	if($this->auth->is_logged_in() == false){
       ...
       // identitas yang mengetahuin / pengguna anggaran
        ...
        $cRet .= "<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"0\" cellspacing=\"1\" cellpadding=\"1\">
			...
			<tr>
                <td width =\"15%\" align=\"left\" style=\"font-size:12px; font-family:tahoma;\">&ensp;SATUAN KERJA</td>
                <td width =\"45%\" align=\"left\" style=\"font-size:12px; font-family:tahoma;\">: $cnm_skpd</td>
				<td width =\"30%\"align=\"left\" style=\"font-size:12px; font-family:tahoma;\"></td>
                <td width =\"10%\" align=\"left\" style=\"font-size:12px; font-family:tahoma;\"></td>
            </tr>
...
mbarang b ON b.kd_brg=a.kd_brg WHERE a.kd_unit='$cbidskpd' AND a.kd_ruang='$kdruangan'
			...
			<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\"  border=\"0\" cellspacing=\"1\" cellpadding=\"1\">
				...
				$cRet .=" </table>";
        $data['prev']= $cRet;
        $this->template->set('title', 'KARTU INVENTARIS RUANGAN');        
        $this->_mpdf('',$cRet,5,5,5,1);
         } 
	}
...
a.asal,a.tahun,a.silinder,a.kd_satuan,a.kondisi,COUNT(a.nilai) AS jumlah,IFNULL(SUM(a.nilai),0) AS nilai,a.keterangan 
FROM trkib_b a left join mbarang b on a.kd_brg=b.kd_brg WHERE a.kd_skpd='$cskpd' AND a.tgl_reg<='$sampai_tgl' AND (a.kondisi='RB' or a.kondisi='HB' or a.kondisi='PM') 
			and a.nilai>=500000
			AND (a.no_mutasi IS NULL OR a.no_mutasi='' OR a.tgl_mutasi>='$sampai_tgl') 
			AND (a.no_pindah IS NULL OR a.no_pindah='' OR a.tgl_pindah>='$sampai_tgl') 
			AND (a.no_hapus IS NULL OR a.no_hapus='' OR a.tgl_hapus>='$sampai_tgl')  
...
SELECT a.kd_brg,IF(MAX(a.no_reg)=MIN(a.no_reg),a.no_reg,CONCAT(MIN(a.no_reg),'-',MAX(a.no_reg)))AS no_reg,b.nm_brg,a.luas_tanah AS merek,a.no_dok AS gabung,a.jenis_gedung AS kd_bahan,a.no_urut,
a.asal,a.tahun,a.konstruksi AS silinder,'' AS kd_satuan,a.kondisi,COUNT(a.nilai) AS jumlah,IFNULL(SUM(a.nilai),0) AS nilai,a.keterangan 
FROM trkib_c a left join mbarang b on a.kd_brg=b.kd_brg WHERE a.kd_skpd='$cskpd' AND a.tgl_reg<='$sampai_tgl' AND (a.kondisi='RB' or a.kondisi='HB' or a.kondisi='PM') 
			and a.nilai>=10000000
			AND (a.no_mutasi IS NULL OR a.no_mutasi='' OR a.tgl_mutasi>='$sampai_tgl') 
			AND (a.no_pindah IS NULL OR a.no_pindah='' OR a.tgl_pindah>='$sampai_tgl') 
			AND (a.no_hapus IS NULL OR a.no_hapus='' OR a.tgl_hapus>='$sampai_tgl')  
			AND (a.tgl_riwayat>'$sampai_tgl' OR a.kd_riwayat IS NULL OR a.kd_riwayat='' OR a.kd_riwayat='9')
...
FROM trkib_d a LEFT JOIN mbarang b ON a.kd_brg=b.kd_brg WHERE a.kd_skpd='$cskpd' AND a.tgl_reg<='$sampai_tgl' 
...
a.peroleh AS asal,a.tahun,a.tipe AS silinder,a.kd_satuan,a.kondisi,COUNT(a.nilai) AS jumlah,IFNULL(SUM(a.nilai),0) AS nilai,a.keterangan 
FROM trkib_e a left join mbarang b on a.kd_brg=b.kd_brg WHERE a.kd_skpd='$cskpd' AND a.tgl_reg<='$sampai_tgl' AND (a.kondisi='RB' or a.kondisi='HB' or a.kondisi='PM') and a.no_hapus is null 
 GROUP BY a.kd_unit,b.nm_brg,a.kd_brg,a.kd_bahan,a.jenis,a.tipe,a.nilai,a.keterangan) faiz  ORDER BY kd_brg,no_reg";
 			 }else{
				  if($jenis=='2'){
				 $csql = "SELECT a.kd_brg,IF(MAX(a.no_reg)=MIN(a.no_reg),a.no_reg,CONCAT(MIN(a.no_reg),'-',MAX(a.no_reg)))AS no_reg,b.nm_brg,a.merek,CONCAT(a.pabrik,'/',no_rangka,'/',no_mesin) AS gabung,a.kd_bahan,a.no_urut,
a.asal,a.tahun,a.silinder,a.kd_satuan,a.kondisi,COUNT(a.nilai) AS jumlah,IFNULL(SUM(a.nilai),0) AS nilai,a.keterangan 
FROM trkib_b a left join mbarang b on a.kd_brg=b.kd_brg WHERE a.kd_skpd='$cskpd' AND a.tgl_reg<='$sampai_tgl' AND (a.kondisi='RB' or a.kondisi='HB' or a.kondisi='PM') 
			and a.nilai>=500000
			AND (a.no_mutasi IS NULL OR a.no_mutasi='' OR a.tgl_mutasi>='$sampai_tgl') 
...
a.peroleh AS asal,a.tahun,a.tipe AS silinder,a.kd_satuan,a.kondisi,COUNT(a.nilai) AS jumlah,IFNULL(SUM(a.nilai),0) AS nilai,a.keterangan 
FROM trkib_e a left join mbarang b on a.kd_brg=b.kd_brg WHERE a.kd_skpd='$cskpd' AND a.tgl_reg<='$sampai_tgl' AND (a.kondisi='RB' or a.kondisi='HB' or a.kondisi='PM')
...
a.peroleh AS asal,a.tahun,a.tipe AS silinder,a.kd_satuan,a.kondisi,COUNT(a.total) AS jumlah,IFNULL(SUM(a.total),0) AS nilai,a.keterangan 
FROM trkib_e a left join mbarang b on a.kd_brg=b.kd_brg WHERE a.kd_skpd='$cskpd' AND a.tgl_reg<='$sampai_tgl' AND (a.kondisi='RB' or a.kondisi='HB' or a.kondisi='PM') and a.no_hapus is null 
 GROUP BY a.kd_unit,b.nm_brg,a.kd_brg,a.kd_bahan,a.jenis,a.tipe,a.total,a.keterangan) faiz  ORDER BY kd_brg,no_reg";
 			 }else{
				  if($jenis=='2'){
				 $csql = "SELECT a.kd_brg,IF(MAX(a.no_reg)=MIN(a.no_reg),a.no_reg,CONCAT(MIN(a.no_reg),'-',MAX(a.no_reg)))AS no_reg,b.nm_brg,a.merek,CONCAT(a.pabrik,'/',no_rangka,'/',no_mesin) AS gabung,a.kd_bahan,a.no_urut,
a.asal,a.tahun,a.silinder,a.kd_satuan,a.kondisi,COUNT(a.total) AS jumlah,IFNULL(SUM(a.total),0) AS nilai,a.keterangan 
	...
	if($this->auth->is_logged_in() == false){
        ...
        $cRet .= "<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"0\" cellspacing=\"1\" cellpadding=\"1\">
            ...
            if($jenis=='1'){
				...
				SELECT a.kd_brg,IF(MAX(a.no_reg)=MIN(a.no_reg),a.no_reg,CONCAT(MIN(a.no_reg),'-',MAX(a.no_reg)))AS no_reg,b.nm_brg,a.merek,CONCAT(a.pabrik,'/',no_rangka,'/',no_mesin) AS gabung,a.kd_bahan,a.no_urut,
				a.asal,a.tahun,a.silinder,a.kd_satuan,a.kondisi,COUNT(a.nilai) AS jumlah,IFNULL(SUM(a.nilai),0) AS nilai,a.keterangan 
				FROM trkib_b a left join mbarang b on a.kd_brg=b.kd_brg WHERE a.kd_skpd='$cskpd' AND a.tgl_reg<='$sampai_tgl' $th and (a.nilai<500000 or a.kd_riwayat='1') and nilai <>'0'  
			AND (a.no_mutasi IS NULL OR a.no_mutasi='' OR a.tgl_mutasi>='$sampai_tgl') 
			AND (a.no_pindah IS NULL OR a.no_pindah='' OR a.tgl_pindah>='$sampai_tgl') 
			AND (a.no_hapus IS NULL OR a.no_hapus='' OR a.tgl_hapus>='$sampai_tgl')  
			AND (a.tgl_riwayat>'$sampai_tgl' OR a.kd_riwayat IS NULL OR a.kd_riwayat='' 
			OR a.kd_riwayat='9')
				...
				SELECT a.kd_brg,IF(MAX(a.no_reg)=MIN(a.no_reg),a.no_reg,CONCAT(MIN(a.no_reg),'-',MAX(a.no_reg)))AS no_reg,b.nm_brg,a.luas_tanah AS merek,a.no_dok AS gabung,a.jenis_gedung AS kd_bahan,a.no_urut,
				a.asal,a.tahun,a.konstruksi AS silinder,'' AS kd_satuan,a.kondisi,COUNT(a.nilai) AS jumlah,IFNULL(SUM(a.nilai),0) AS nilai,a.keterangan 
				FROM trkib_c a left join mbarang b on a.kd_brg=b.kd_brg WHERE a.kd_skpd='$cskpd' AND a.tgl_reg<='$sampai_tgl' $th and (a.nilai<10000000 or a.kd_riwayat='1') and nilai <>'0'  
			AND (a.no_mutasi IS NULL OR a.no_mutasi='' OR a.tgl_mutasi>='$sampai_tgl') 
			AND (a.no_pindah IS NULL OR a.no_pindah='' OR a.tgl_pindah>='$sampai_tgl') 
			AND (a.no_hapus IS NULL OR a.no_hapus='' OR a.tgl_hapus>='$sampai_tgl')  
			AND (a.tgl_riwayat>'$sampai_tgl' OR a.kd_riwayat IS NULL OR a.kd_riwayat='' OR a.kd_riwayat='9')
				...
				SELECT a.kd_brg,IF(MAX(a.no_reg)=MIN(a.no_reg),a.no_reg,CONCAT(MIN(a.no_reg),'-',MAX(a.no_reg)))AS no_reg,b.nm_brg,a.merek,CONCAT(a.pabrik,'/',no_rangka,'/',no_mesin) AS gabung,a.kd_bahan,a.no_urut,
				a.asal,a.tahun,a.silinder,a.kd_satuan,a.kondisi,COUNT(a.total) AS jumlah,IFNULL(SUM(a.total),0) AS nilai,a.keterangan 
				FROM trkib_b a left join mbarang b on a.kd_brg=b.kd_brg WHERE a.kd_skpd='$cskpd' AND a.tgl_reg<='$sampai_tgl' $th and (a.total<500000 or a.kd_riwayat='1') and total <>'0'
			AND (a.no_mutasi IS NULL OR a.no_mutasi='' OR a.tgl_mutasi>='$sampai_tgl') 
			AND (a.no_pindah IS NULL OR a.no_pindah='' OR a.tgl_pindah>='$sampai_tgl') 
			AND (a.no_hapus IS NULL OR a.no_hapus='' OR a.tgl_hapus>='$sampai_tgl')  
			AND (a.tgl_riwayat>'$sampai_tgl' OR a.kd_riwayat IS NULL OR a.kd_riwayat='' OR a.kd_riwayat='9')
				...
				SELECT a.kd_brg,IF(MAX(a.no_reg)=MIN(a.no_reg),a.no_reg,CONCAT(MIN(a.no_reg),'-',MAX(a.no_reg)))AS no_reg,b.nm_brg,a.luas_tanah AS merek,a.no_dok AS gabung,a.jenis_gedung AS kd_bahan,a.no_urut,
				a.asal,a.tahun,a.konstruksi AS silinder,'' AS kd_satuan,a.kondisi,COUNT(a.total) AS jumlah,IFNULL(SUM(a.total),0) AS nilai,a.keterangan 
				FROM trkib_c a left join mbarang b on a.kd_brg=b.kd_brg WHERE a.kd_skpd='$cskpd' AND a.tgl_reg<='$sampai_tgl' $th and (a.total<10000000 or a.kd_riwayat='1') and total <>'0' 
			AND (a.no_mutasi IS NULL OR a.no_mutasi='' OR a.tgl_mutasi>='$sampai_tgl') 
			AND (a.no_pindah IS NULL OR a.no_pindah='' OR a.tgl_pindah>='$sampai_tgl') 
			AND (a.no_hapus IS NULL OR a.no_hapus='' OR a.tgl_hapus>='$sampai_tgl')  
			AND (a.tgl_riwayat>'$sampai_tgl' OR a.kd_riwayat IS NULL OR a.kd_riwayat='' OR a.kd_riwayat='9')
 ...
 */	$this->fpdf->Setx(273);
	...
	foreach ($hsl1->result() as $row)
			...
			WHERE a.kd_skpd='$skpd' AND a.tgl_reg<='$sampai_tgl' $th 
			and (a.total<10000000 or a.kd_riwayat='1') and total <>'0' 
			AND (a.no_mutasi IS NULL OR a.no_mutasi='' OR a.tgl_mutasi>='$sampai_tgl') 
			AND (a.no_pindah IS NULL OR a.no_pindah='' OR a.tgl_pindah>='$sampai_tgl') 
			AND (a.no_hapus IS NULL OR a.no_hapus='' OR a.tgl_hapus>='$sampai_tgl')  
			AND (a.tgl_riwayat>'$sampai_tgl' OR a.kd_riwayat IS NULL OR a.kd_riwayat='' 
...
/* 			 }
  ...
  /*       if($lctahu==''){
	...
	$sql1="SELECT sum(a.nilai) as nilai,count(nilai) as jumlah FROM trkib_b a left join mbarang b on a.kd_brg=b.kd_brg 
			WHERE a.no_hapus is null AND (a.kondisi='RB' or a.kondisi='HB' or a.kondisi='PM') and a.kd_skpd='$skpd' $th AND (a.no_mutasi IS NULL OR a.no_mutasi='' OR a.tgl_mutasi>='$sampai_tgl') 
			AND (a.no_pindah IS NULL OR a.no_pindah='' OR a.tgl_pindah>='$sampai_tgl') 
			AND (a.no_hapus IS NULL OR a.no_hapus='' OR a.tgl_hapus>='$sampai_tgl')";	
	$hsl1 = $this->db->query($sql1);	 
	foreach ($hsl1->result() as $row)
	...
	$sql2="SELECT sum(a.nilai) as nilai,count(nilai) as jumlah FROM trkib_c a left join mbarang b on a.kd_brg=b.kd_brg 
			WHERE a.kd_skpd='$skpd' AND (a.kondisi='RB' or a.kondisi='HB' or a.kondisi='PM') $th AND (a.no_mutasi IS NULL OR a.no_mutasi='' OR a.tgl_mutasi>='$sampai_tgl') 
			AND (a.no_pindah IS NULL OR a.no_pindah='' OR a.tgl_pindah>='$sampai_tgl') 
			AND (a.no_hapus IS NULL OR a.no_hapus='' OR a.tgl_hapus>='$sampai_tgl')";	
	$hsl2 = $this->db->query($sql2);	 
	foreach ($hsl2->result() as $row)
	...
	$sql4="SELECT sum(a.nilai) as nilai,count(nilai) as jumlah FROM trkib_e a left join mbarang b on a.kd_brg=b.kd_brg 
			 WHERE a.kd_skpd='$skpd' $th AND (a.kondisi='RB' or a.kondisi='HB' or a.kondisi='PM') and (a.no_mutasi IS NULL OR a.no_mutasi='' OR a.tgl_mutasi>='$sampai_tgl') 
			AND (a.no_pindah IS NULL OR a.no_pindah='' OR a.tgl_pindah>='$sampai_tgl') 
			AND (a.no_hapus IS NULL OR a.no_hapus='' OR a.tgl_hapus>='$sampai_tgl')";	
	$hsl4 = $this->db->query($sql4);	 
	foreach ($hsl4->result() as $row)
	...
	$sql4="SELECT sum(a.total) as nilai,count(a.total) as jumlah FROM trkib_e a left join mbarang b on a.kd_brg=b.kd_brg 
			 WHERE a.kd_skpd='$skpd' $th AND (a.kondisi='RB' or a.kondisi='HB' or a.kondisi='PM') 
			 AND (a.no_mutasi IS NULL OR a.no_mutasi='' OR a.tgl_mutasi>='$sampai_tgl') 
			AND (a.no_pindah IS NULL OR a.no_pindah='' OR a.tgl_pindah>='$sampai_tgl') 
			AND (a.no_hapus IS NULL OR a.no_hapus='' OR a.tgl_hapus>='$sampai_tgl')";	
	$hsl4 = $this->db->query($sql4);	 
...
/* $csql ="SELECT a.kd_brg AS kode,b.nm_brg,a.merek,a.tahun,if($pnilai='1',a.`nilai`,a.total) as nilai,TRIM(c.umur) AS umur,
...
WHERE kd_barang<>'' 
AND kd_skpd='$kdbid' AND tahun<='$tahun' and 
(a.nilai>=500000 or a.kd_riwayat='9') 
and a.kondisi<>'RB' and a.tahun<>'2015' ORDER BY a.kd_brg,a.tahun";  */
$csql="SELECT a.kd_brg AS kode,b.nm_brg,a.merek,a.tahun,if($pnilai='1',a.`nilai`,a.total) as nilai,
TRIM(c.umur) AS umur,
if(a.tahun='$tahun',0,($tahun-a.tahun)) AS th_lalu,$tahun AS th_ini,a.tahun,
...
LEFT JOIN mbarang_umur c ON c.kd_barang=LEFT(a.kd_brg,8) 
WHERE kd_barang<>'' 
AND kd_skpd='$kdbid' AND YEAR(a.tgl_oleh)<'$tahun' AND a.tgl_oleh<='$tahun-12-31' and 
($fnilai>=500000 or a.kd_riwayat='9') $lutji
and a.kondisi<>'RB' and a.tahun<>'2015' ORDER BY a.kd_brg,a.tahun";
...
WHERE kd_barang<>'' 
AND a.kd_skpd='$kdbid' AND year(a.tgl_oleh)='2015' and 
($fnilai>=500000 or a.kd_riwayat='9') 
and a.kondisi<>'RB' ORDER BY a.kd_brg,a.tahun"; 
             $hasil = $this->db->query($csql);
             $i = 0;
             $nilai = 0;
...
/*                  $csql ="SELECT a.kd_brg AS kode,b.nm_brg,'' as merek,a.tahun,a.`nilai`,TRIM(c.umur) AS umur,
if(a.tahun='$tahun',0,($tahun-a.tahun)) AS th_lalu,$tahun AS th_ini,a.tahun,
(a.nilai/TRIM(c.umur)) AS penyusutan_pertahun,
...
WHERE kd_barang<>'' 
AND kd_skpd='$kdbid' AND tahun<='$tahun' and 
(a.nilai>=10000000 or a.kd_riwayat='9') and a.kondisi<>'RB' 
and a.tahun<>'2015' ORDER BY a.kd_brg,a.tahun";  */  
//(SELECT if($pnilai='1',SUM(nilai),SUM(total)) FROM trkib_c_kap WHERE kd_skpd=a.kd_skpd and a.kd_unit=kd_unit 
//and a.id_barang=id_barang and tgl_reg<='$tahun-12-31')
...
WHERE kd_barang<>'' 
AND kd_skpd='$kdbid' AND YEAR(a.tgl_oleh)<'$tahun' AND a.tgl_oleh<='$tahun-12-31' and 
($fnilai>=10000000 or a.kd_riwayat='9') and a.kondisi<>'RB' 
and a.tahun<>'2015' ORDER BY a.kd_brg,a.tahun";          
            ...
            /*  $nilai 	= $nilai+$row->nilai;
			 ...
			 $cRet .="
                 <tr>
                    ...
                    <td align=\"center\" width =\"2%\" style=\"font-size:10px; font-family:tahoma;\">$row->umur</td>
                    <td align=\"center\" width =\"2%\" style=\"font-size:10px; font-family:tahoma;\">$row->th_lalu</td>
					<td align=\"right\" width =\"10%\" style=\"font-size:10px; font-family:tahoma;\">".number_format($cinta)."</td>
					<td align=\"right\" width =\"10%\" style=\"font-size:10px; font-family:tahoma;\">".number_format($kamu)."</td>
					<td align=\"right\" width =\"10%\" style=\"font-size:10px; font-family:tahoma;\">".number_format($vero)."</td>
					<td align=\"right\" width =\"10%\" style=\"font-size:10px; font-family:tahoma;\">".number_format($falove)."</td>
					</tr>";
			 }
			 	 $cRet .="
                 <tr>
...
LEFT JOIN mbarang_umur c ON c.kd_barang=LEFT(a.kd_brg,8) 
WHERE kd_barang<>'' 
AND kd_skpd='$kdbid' and (a.nilai>=0 or a.kd_riwayat='9') and a.kondisi<>'RB'
AND tahun<='$tahun' and a.tahun<>'2015' ORDER BY a.kd_brg,a.tahun"; */       
...
LEFT JOIN mbarang_umur c ON c.kd_barang=LEFT(a.kd_brg,8) 
WHERE kd_barang<>'' 
AND kd_skpd='$kdbid' and ($fnilai>=0 or a.kd_riwayat='9') and a.kondisi<>'RB' $lutji
AND YEAR(a.tgl_oleh)<'$tahun' AND a.tgl_oleh<='$tahun-12-31' and a.tahun<>'2015' ORDER BY a.kd_brg,a.tahun";     
...
LEFT JOIN mbarang_umur c ON c.kd_barang=LEFT(a.kd_brg,8) 
WHERE kd_barang<>'' 
AND kd_skpd='$kdbid' AND tahun<='$tahun' 
and (a.nilai>=0 or a.kd_riwayat='9') and a.kondisi<>'RB' 
and a.tahun<>'2015' ORDER BY a.kd_brg,a.tahun";  */          
...
and ($fnilai>=0 or a.kd_riwayat='9') and a.kondisi<>'RB' $lutji
and a.tahun<>'2015' ORDER BY a.kd_brg,a.tahun"; 
             $hasil = $this->db->query($csql);
             $i = 0;
             $nilai = 0;
